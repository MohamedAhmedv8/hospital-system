                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach ($GroupsItems as $index => $groupItem)
                            <tr>
                                ...
                                <td>
                                    @if($groupItem['is_saved'])
                                        <input type="hidden" name="GroupsItems[{{$index}}][quantity]"wire:model="GroupsItems.{{$index}}.quantity"/>{{ $groupItem['quantity'] }}
                                    @else
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-sm btn-success mr-1" wire:click.prevent="saveService({{$index}})">تاكيد</button>
                                    @endif
