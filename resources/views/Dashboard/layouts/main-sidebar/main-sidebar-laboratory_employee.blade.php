...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category">{{ trans('Dashboard/main-sidebar_trans.laboratory_section') }}</li>
            <li class="slide">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('laboratory_invoices.index') }}">{{ trans('Dashboard/main-sidebar_trans.show_all') }}</a></li>
                    <li><a class="slide-item" href="{{ route('completed_Laboratories_invoices') }}">{{ trans('Dashboard/main-sidebar_trans.archive') }}</a></li>
                </ul>
            </li>
        </ul>
    </div>
