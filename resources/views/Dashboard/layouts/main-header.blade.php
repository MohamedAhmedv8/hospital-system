							...
							<li class="">
								<div class="dropdown  nav-itemd-none d-md-flex">
									<a href="#" class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown" aria-expanded="false">
										@if(App::getLocale()=='ar')
										<span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img src="{{URL::asset('Dashboard/img/flags/eg.png')}}" alt="img"></span>
...
{{--  --}}
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								...
								<div class="dropdown-menu">
									...
									<a class="dropdown-item" href="route('logout')"
										onclick="event.preventDefault(); this.closest('form').submit();"><i class="bx bx-log-out"></i> Sign Out</a>
									</form>
								</div>
							</div>
			...
			<script>
				...
				var new_notification = notificationsWrapper.find('.new_notification');
				new_notification.hide();
    Pusher.logToConsole = true;
    var pusher = new Pusher('069da9b7214a49f805be', {
		cluster: 'mt1'
    });
