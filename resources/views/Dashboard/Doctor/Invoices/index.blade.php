                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        ...
                                        @foreach($invoices as $invoice)
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu tx-13">
                                                            ...
                                                            <a class="dropdown-item" href="#" data-toggle="modal" data-target="#laboratory_conversion{{$invoice->id}}"><i class="text-warning fas fa-syringe"></i>&nbsp;&nbsp;تحويل الي المختبر </a>
                                            ...
                                            @include('Dashboard.Doctor.Invoices.Laboratory_conversion')
                                        @endforeach
                                            </tbody>
                                        </table>
                                    </div>
