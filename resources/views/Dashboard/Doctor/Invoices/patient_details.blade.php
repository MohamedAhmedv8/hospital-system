                                                    ...
                                                    @foreach($patient_rays as $patient_ray)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                @elseif ($patient_ray->doctor_id == auth()->user()->id && $patient_ray->case == 1)
                                                                    <a class="modal-effect btn btn-sm btn-primary" href="{{ route('invoice.show',$patient_ray->id) }}">عرض</a>
                                                                @endif
                                                            </td>
                                                        </tr>
                                                ...
                                                <table class="table table-hover text-md-nowrap text-center">
                                                    ...
                                                    @foreach($patient_laboratories as $patient_laboratory)
                                                        <tr>
                                                            ...
                                                            <td>{{$patient_laboratory->created_at}}</td>
                                                            <td>


                                                                @if($patient_laboratory->doctor_id == auth()->user()->id &&  $patient_laboratory->case == 0)
                                                                    ...
                                                                    <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"  data-toggle="modal" href="#deleted_laboratory{{$patient_laboratory->id}}"><i class="las la-trash"></i></a>
                                                                    @elseif ($patient_laboratory->doctor_id == auth()->user()->id && $patient_laboratory->case == 1)
                                                                    <a class="modal-effect btn btn-sm btn-primary" href="{{ route('view_laboratory',$patient_laboratory->id) }}">عرض</a>
                                                                    @endif

                                                            </td>
                                                        </tr>
                                                        @include('Dashboard.doctor.invoices.edit_Laboratory_conversion')
                                                        @include('Dashboard.doctor.invoices.delete_Laboratory')
                                                    @endforeach
                                                    </tbody>
                                                </table>
                                            </div>
