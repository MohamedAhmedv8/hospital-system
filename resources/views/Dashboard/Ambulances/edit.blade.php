...
@section('title')
{{ trans('Dashboard/ambulances_trans.edit') }}
@endsection
@section('css')
    <!--Internal   Notify -->
...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">{{ trans('Dashboard/ambulances_trans.ambulances') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('Dashboard/ambulances_trans.edit') }}</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('ambulances.update','test')}}" method="post">
                    ...
                    <div class="row">
                        <div class="col">
                            <label>{{ trans('Dashboard/ambulances_trans.car_number') }}</label>
                        ...
                        <div class="col">
                            <label>{{ trans('Dashboard/ambulances_trans.car_model') }}</label>
                            <input type="text" name="car_model"  value="{{$ambulance->car_model}}" class="form-control @error('car_model') is-invalid @enderror">
                        </div>

                        <div class="col">
                            <label>{{ trans('Dashboard/ambulances_trans.car_year_made') }}</label>
                        ...
                        <div class="col">
                            <label>{{ trans('Dashboard/ambulances_trans.car_type') }}</label>
                            <select class="form-control" name="car_type">
                                <option value="1" {{$ambulance->car_type == 1 ? 'selected':''}}>{{ trans('Dashboard/ambulances_trans.Owned') }}</option>
                                <option value="2" {{$ambulance->car_type == 2 ? 'selected':''}}>{{ trans('Dashboard/ambulances_trans.rent') }}</option>
                            </select>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-3">
                            <label>{{ trans('Dashboard/ambulances_trans.driver_name') }}</label>
                            <input type="text" name="driver_name"  value="{{$ambulance->driver_name}}" class="form-control @error('driver_name') is-invalid @enderror">
                        </div>

                        <div class="col-3">
                            <label>{{ trans('Dashboard/ambulances_trans.driver_license_number') }}</label>
                        ...
                        <div class="col-6">
                            <label>{{ trans('Dashboard/ambulances_trans.driver_phone') }}</label>
                    ...
                    <div class="row">
                        <div class="col">
                            <label>{{ trans('Dashboard/ambulances_trans.notes') }}</label>
                    ...
                    <div class="row">
                        <div class="col">
                            <label>{{ trans('Dashboard/ambulances_trans.is_available') }}</label>
                            &nbsp;
