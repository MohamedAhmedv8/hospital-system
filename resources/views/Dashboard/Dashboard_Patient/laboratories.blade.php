                                    ...
                                    <div class="table-responsive">
                                        ...
                                        @foreach($laboratories as $laboratory)
                                            <tr>
                                                ...
                                                <td>{{$laboratory->employee->name}}</td>
                                                <td>{{$laboratory->description_employee}}</td>
                                                <td>
                                                    @if ($laboratory->case == 1 && $laboratory->patient_id == auth()->user()->id)
                                                    <a class="modal-effect btn btn-sm btn-primary" href="{{ route('view_laboratory',$laboratory->id) }}">عرض</a>
                                                    @endif
                                                </td>
                                            </tr>
                                        @endforeach
