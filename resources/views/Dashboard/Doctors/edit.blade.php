        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{trans('Dashboard/doctors_trans.doctors')}}</h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{trans('Dashboard/doctors_trans.edit_doctor')}}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                ...
                <div class="card-body">
                    <form action="{{ route('Doctors.update', 'test') }}" method="post" autocomplete="off" enctype="multipart/form-data">
                        ...
                        <div class="pd-30 pd-sm-40 bg-gray-200">
                            <div>
                                @if($doctor->image)
                                    <img style="border-radius:20%"
                                        src="{{ asset("storage/$doctor->image") }}" height="150px" width="150px" alt="">
                                @else
                                    <img style="border-radius:50%"
                                        src="{{ asset('Dashboard/img/doctor-icon.png') }}" height="50px" width="50px" alt="">
                                @endif
                            </div>
                            <br><br>
                            ...
                            <div class=" row row-xs align-items-center mg-b-20">
                                <div class="col-md-1">
                                    <label for="exampleInputEmail1">{{ trans('Dashboard/doctors_trans.appointments') }}</label>
                                </div>
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-1">
                                    <label for="exampleInputEmail1">{{ trans('Dashboard/doctors_trans.number_of_statements') }}</label>
                                </div>
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
