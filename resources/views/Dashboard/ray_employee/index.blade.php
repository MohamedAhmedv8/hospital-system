...
@section('title')
{{trans('Dashboard/ray_employee_trans.list_employee_ray')}}
@stop
@section('css')
...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{trans('Dashboard/ray_employee_trans.ray')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{trans('Dashboard/ray_employee_trans.list_employee')}}</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                            ...
                            <div class="card">
                                <div class="card-header pb-0">
                                    <div class="d-flex justify-content-between">
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add">{{trans('Dashboard/ray_employee_trans.add_new_employee')}}</button>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table style="text-align: center" class="table text-md-nowrap" id="example1">
                                            ...
                                            <tr>
                                                <th>#</th>
                                                <th>{{trans('Dashboard/ray_employee_trans.name')}}</th>
                                                <th >{{trans('Dashboard/ray_employee_trans.email')}}</th>
                                                <th>{{trans('Dashboard/ray_employee_trans.data')}}</th>
                                                <th>{{trans('Dashboard/ray_employee_trans.action')}}</th>
                                            </tr>
                                            </thead>
                                            <tbody>
