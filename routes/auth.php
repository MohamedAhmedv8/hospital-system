...
Route::middleware('guest')->group(function () {
    ...
    Route::post('login/laboratory_employee', [LaboratoryEmployeeController::class, 'store'])->name('login.laboratory_employee');
...
Route::post('logout/laboratory_employee', [LaboratoryEmployeeController::class, 'destroy'])->middleware('auth:laboratory_employee')->name('logout.laboratory_employee');
